 ...
 * @returns {Void}
 */
function PrintVendorBill(type,form){
	...
	if(type == 'view')
	{
		...
		if(recType == 'vendorbill')
		{
			if(recId != '' && recId != null) 
			{
				...
				var url = nlapiResolveURL('SUITELET', 'customscript_prg_st_vendorbill', 'customdeploy_prg_st_vendorbill');
				...
				var action = '&action=VendorBillPrint';
