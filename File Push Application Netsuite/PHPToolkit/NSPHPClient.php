...
class NSPHPClient {
    ...
    public function setApplicationInfo($nsappid) {
        ...
        $applicationInfo->applicationId = $nsappid;
    ...
    public function setTokenGenerator(iTokenPassportGenerator $generator) {
