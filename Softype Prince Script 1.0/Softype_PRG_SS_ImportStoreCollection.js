...
function scheduled(type) {
	...
	var unprocessFolder = 291;
	var processedFolder = 292;
	...
	if(totalFiles)
	{
		...
		for(var t = 0; t < totalFiles.length; t++)
		{
			...
			if(usage <= 500){
				...
				var status = nlapiScheduleScript('customscript_prg_ss_importstorecollectio','customdeploy_prg_ss_importstorecollectio');
			...
			import3.setMapping('CUSTIMPORT_STORE_COLLECTION');
